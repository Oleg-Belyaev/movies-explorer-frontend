      ...
      <section className="registr main__registr">
        ...
        <form className="registr__form" name="register" onSubmit={handleSubmit}>
          <div className="registr__field">
            ...
            <input type="text" className={`${errors.name ? 'registr__input registr__input_error' : 'registr__input'}`} 
          ...
          <div className="registr__field">
            ...
            <input type="email" className={`${errors.email ? 'registr__input registr__input_error' : 'registr__input'}`} 
          ...
          <div className="registr__field">
            ...
            <input type="password" className={`${errors.password ? 'registr__input registr__input_error' : 'registr__input'}`} 
            ...
            <button type="submit" className={`${isValid ? "registr__button" : "registr__button registr__button_inactive"}`}>Зарегистрироваться</button>
        </form>
